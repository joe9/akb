...
stickyUpdateModifiers _ m state
  ...
  | elem m (sLatchedModifiers state) =
    state {sLockedModifiers = m : sLockedModifiers state}
  | elem m (sEffectiveModifiers state) =
    state {sLatchedModifiers = m : sLatchedModifiers state}
