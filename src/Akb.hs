...
keyEvent :: State -> KeyCode -> KeyDirection -> (Maybe KeySymbol, State)
keyEvent state keycode Pressed  =  onKeyPress   keycode state
keyEvent state keycode Released =  onKeyRelease keycode state
